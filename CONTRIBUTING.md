Contributing to MasterStake
============================

The MasterStake project operates an open contributor model where anyone is
...
Patches that change MasterStake consensus rules are considerably more involved than
...
Where a patch set proposes to change the MasterStake consensus, it must have been
...
The project leader is the release manager for each MasterStake release.
