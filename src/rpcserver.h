...
/**
 * MasterStake RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzmasterseed(const UniValue& params, bool fHelp);
extern UniValue getzmasterseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzmaster(const UniValue& params, bool fHelp);
extern UniValue dzmasterstate(const UniValue& params, bool fHelp);
