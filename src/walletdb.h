...
public:
    ...
    bool WriteZMASTERSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZMASTERSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZMASTERSeed_deprecated(uint256& seed);
    bool EraseZMASTERSeed();
    bool EraseZMASTERSeed_deprecated();

    bool WriteZMASTERCount(const uint32_t& nCount);
    bool ReadZMASTERCount(uint32_t& nCount);
