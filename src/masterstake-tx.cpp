...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MasterStake masterstake-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  masterstake-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded masterstake transaction") + "\n" +
                               "  masterstake-tx [options] -create [commands]   " + _("Create hex-encoded masterstake transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded masterstake transaction
