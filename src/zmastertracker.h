...
#ifndef MasterStake_ZMASTERTRACKER_H
#define MasterStake_ZMASTERTRACKER_H
...
public:
    CzMASTERTracker(std::string strWalletFile);
    ~CzMASTERTracker();
...
#endif //MasterStake_ZMASTERTRACKER_H
