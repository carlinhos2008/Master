...
// Copyright (c) 2015-2018 The MasterStake Developers
                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMASTERPathCustom = GetArg("-zmasterbackuppath", "");
    ...
    if(!strzMASTERPathCustom.empty()) {
        ui->wallet_customzmasterbackuppath->setText(QString::fromStdString(strzMASTERPathCustom));
        ui->wallet_customzmasterbackuppath_label->setVisible(true);
        ui->wallet_customzmasterbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMASTERPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MasterStake RPC console.") + "<br>" +
