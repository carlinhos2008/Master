                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MasterStake") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MasterStake address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and masterstake: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Access the site and get all the information about Master Protocol"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MasterStake"), this);
    aboutAction->setStatusTip(tr("Show information about MasterStake"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MasterStake"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MasterStake addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MasterStake addresses"));
    ...
    openAction->setStatusTip(tr("Open a MasterStake: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gentaium Core help message to get a list with possible MasterStake command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MasterStake client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MasterStake network", "", count));
}
...
{
    QString strTitle = tr("MasterStake"); // default title
