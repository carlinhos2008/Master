...
/** Utility functions used by the MasterStake Qt UI.
 */
namespace GUIUtil
{
...
// Render MasterStake addresses in monospace font
...
// Parse "masterstake:" URI into recipient object, return true on successful parsing
