...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("MASTER Stake");
    case TransactionRecord::StakeZMASTER:
        return tr("zMASTER Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted MASTER to zMASTER");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zMASTER");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received MASTER from zMASTER");
    case TransactionRecord::ZerocoinSpend_Change_zMaster:
        return tr("Minted Change as zMASTER from zMASTER Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zMASTER to MASTER");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zMaster:
        return tr("Anonymous (zMASTER Transaction)");
    case TransactionRecord::StakeZMASTER:
        return tr("Anonymous (zMASTER Stake)");
    case TransactionRecord::SendToSelf:
    default:
