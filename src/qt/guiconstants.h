...
/* MasterStake GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MasterStake"
#define QAPP_ORG_DOMAIN "masterstake.foundation"
#define QAPP_APP_NAME_DEFAULT "MasterStake"
#define QAPP_APP_NAME_TESTNET "MasterStake-Qt-testnet"
