...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MasterStake"),
     ...
     * override -datadir in the masterstake.conf file in the default data directory
     * (to be consistent with masterstaked behavior)
     */
    if (dataDir != getDefaultDataDirectory())
