...
In order to support loading of multiple wallets in masterstake-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is masterstake.cpp.
...
Changes to masterstake.cpp
----------------------
masterstake.cpp is the entry point into masterstake-qt, and as such, will require some minor modifications to provide hooks for
