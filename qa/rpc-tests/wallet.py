...
#   c) node1 mines 32 blocks, so now node 0 has 60001master, node 1 has 4250master, node2 has none.
#   d) node0 sends 601 master to node2, in two transactions (301 master, then 300 master).
